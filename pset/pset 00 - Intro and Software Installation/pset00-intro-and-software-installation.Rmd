...
g = ggplot(iris, 
            aes(x = Petal.Width, 
                y = Petal.Length)) + 
  geom_point() + 
  ggtitle("Daniela Fernandez's animation")
g
...
#a  ## check that the animation works #commented out animation code so 
#that document can knit
